    ...
    <form action="/admin/topping/simpan"  method="post">
        ...
        <div class="row py-2">
            <div class="col-sm">
                ...
                <input type="text" name="nama" id="" class="form-control" placeholder="input nama topping" @if ($curTopping) value="{{ $curTopping->nama }}" @endif>
            </div>
            <div class="col-sm"></div>
        </div>
        <div class="row py-2">
            <div class="col-sm">
                ...
                <input type="file" name="gambar" id="" class="form-control" placeholder="input gambar topping" @if ($curTopping) value="{{ $curTopping->gambar }}" @endif>
            </div>
            <div class="col-sm"></div>
        </div>
        <div class="row py-2">
            <div class="col-sm">
                ...
                <input type="number" name="harga" id="" class="form-control" placeholder="input harga topping" @if ($curTopping) value="{{ $curTopping->harga }}" @endif>
            </div>
            <div class="col-sm"></div>
        </div>
        <div class="row py-2">
        ...
        <tbody>
            @forelse ($topping as $key => $m)
                <tr class="align-middle">
                    ...
                    <td scope="row" ><img src='{{ asset("topping/$m->gambar") }}' alt="Tidak ada gambar" style="width: 10em ;height: 10em;"></td>
                    <td scope="row" >{{ $m->harga }}</td>
                    <td style="text-align: center" >
                        <a href='{{ url("admin/topping/$m->id_topping") }}'
